...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_checkpoint', type=str, default=None, help='pretrained checkpoint to init from (V2 fine-tuning)')
    ...
    parser.add_argument('--no_save_npy', action='store_true', help='do not save pred/true npy (disk saving)')
    parser.add_argument('--no_visual', action='store_true', help='do not save visualization PDFs')
